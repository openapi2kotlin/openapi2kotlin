...
internal class Http4kServerInterfaceGenerator : GenerateApiPort {
    ...
    private fun generateBodyMethod(
        ...
        baseFunBuilder(ep, ctx)
            .returns(Http4kServerApiPolicy.bodyReturnType(ep, ctx))
            .build()
    ...
    private fun generateHttpInfoMethod(
        ...
        baseFunBuilder(ep, ctx, suffix = "WithHttpInfo")
            .returns(Http4kServerApiPolicy.httpInfoReturnType())
            .build()
