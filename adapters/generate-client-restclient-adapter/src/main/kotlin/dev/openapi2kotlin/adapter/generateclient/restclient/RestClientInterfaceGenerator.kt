...
internal class RestClientInterfaceGenerator : GenerateApiPort {
    ...
    private fun generateBodyMethod(
        ...
        baseFunBuilder(ep, ctx)
            .returns(RestClientApiPolicy.bodyReturnType(ep, ctx))
            .build()
    ...
    private fun generateResponseSpecMethod(
        ...
        baseFunBuilder(ep, ctx, suffix = "WithResponseSpec")
