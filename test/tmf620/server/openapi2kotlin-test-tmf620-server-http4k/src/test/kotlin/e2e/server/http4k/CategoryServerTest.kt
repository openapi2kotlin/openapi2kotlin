            ...
            categoryRoutes(
                object : CategoryApi {
                    override fun listCategories(
                        ...
                        limit: Long?,
                        sort: String?,
                    ): List<Category> = listOf(Category(id = "cat-1", name = "Demo category"))

                    override fun listCategoriesWithHttpInfo(
                        fields: String?,
                        offset: Long?,
                        limit: Long?,
                        sort: String?,
                    ...
                    override fun createCategory(
                        fields: String?,
                        body: e2e.server.http4k.generated.model.CategoryFVO,
                    ): Category =
                        Category(
                            id = "cat-2",
                            name = body.name,
                    ...
                    override fun createCategoryWithHttpInfo(
                        fields: String?,
                        body: e2e.server.http4k.generated.model.CategoryFVO,
                    ): Response =
                        Response(
                    ...
                    override fun retrieveCategory(
                        id: String,
                        fields: String?,
                    ): Category = Category(id = id, name = "Demo category")

                    override fun retrieveCategoryWithHttpInfo(
                        id: String,
                        fields: String?,
                    ...
                    override fun patchCategory(
                        id: String,
                        fields: String?,
                        body: e2e.server.http4k.generated.model.CategoryMVO,
                    ): Category =
                        Category(
                            id = id,
                        )

                    override fun patchCategoryWithHttpInfo(
                        id: String,
                        fields: String?,
                        body: e2e.server.http4k.generated.model.CategoryMVO,
                    ): Response =
            ...
            categoryRoutes(
                object : CategoryApi {
                    ...
                    override fun retrieveCategory(
                        id: String,
                        fields: String?,
                    ): Category = Category(id = id, name = "ignored")
