            ...
            petRoutes(
                object : PetApi {
                    ...
                    override fun createPetWithHttpInfo(body: Pet): Response =
                        Response(Status.CREATED).body(json.encodeToString(body))
                    ...
                    override fun listFindByStatusWithHttpInfo(status: String?): Response =
                        Response(Status.OK)
                            ...
                            .body(
                                """
                                [{"id":1,"name":"Doggie","photoUrls":["photo"],"status":"${status ?: "available"}"}]
                                """.trimIndent(),
                            )
                    ...
                    override fun createUploadImage(
                        ...
                        body: ByteArray?,
                    ) = e2e.petstore3.server.http4k.generated.model.ApiResponse(
                        code = 200,
                ...
                storeRoutes(
                    object : StoreApi {
                        ...
                        override fun retrieveStoreWithHttpInfo(orderId: Long): Response =
                            Response(
                                Status.OK,
                            ).body(json.encodeToString(Order(id = orderId)))
