...
| `model.classNameSuffix` | Suffix appended to every generated model class/interface/enum name, e.g. `Dto` | - | false | - |
...
| `client.apiNameFromTags` | Groups generated API classes by the first OpenAPI tag instead of the first URL path segment. | true, false | false | false |
...
| `server.apiNameFromTags` | Groups generated API classes by the first OpenAPI tag instead of the first URL path segment. | true, false | false | false |
